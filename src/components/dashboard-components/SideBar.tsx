...
export const SideBar = () => {
    ...
    return (
        <div className="flex flex-col flex-wrap w-full h-full justify-between items-center p-4">
            <div className="flex flex-col justify-center items-center p4 gap-2">
                <h1 className="text-2xl text-white mb-5 mt-5">WOOFQUEST</h1>
                <img className="flex w-full h-auto p-4 border-8 rounded-full bg-blue-950" src={avatarUrl} alt="avatarPerson" />
